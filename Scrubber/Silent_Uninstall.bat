...
cscript.exe .\OffScrub03.vbs ALL /log "C:\Logs" /quiet
::Scrub Office 2007
Echo "Removing Office 2007"
cscript.exe .\OffScrub07.vbs ALL /log "C:\Logs" /quiet
::Scrub Office 2010
Echo "Removing Office 2010"
cscript.exe .\OffScrub10.vbs ALL /log "C:\Logs" /quiet
::Scrub Office 2013
Echo "Removing Office 2013 (MSI)"
cscript.exe .\OffScrub_O15msi.vbs ALL /log "C:\Logs" /quiet
::Scrub Office 2016
Echo "Removing Office 2016 (MSI)"
cscript.exe .\OffScrub_O16msi.vbs ALL /log "C:\Logs" /quiet
::Scrub Office Click-To-Run
Echo "Removing Office 365 (Click-To-Run)"
cscript.exe .\OffScrubC2R.vbs ALL /log "C:\Logs" /quiet
:: Remove Lync 2010
